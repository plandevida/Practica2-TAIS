...
${OBJECTDIR}/_ext/1954233655/GrafoNombres.o: ../../Practica2-TAIS/GrafoNombres.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1954233655/GrafoNombres.o ../../Practica2-TAIS/GrafoNombres.cpp

${OBJECTDIR}/_ext/972950885/SplitString.o: ../../Practica2-TAIS/SplitString/SplitString.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/972950885
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/972950885/SplitString.o ../../Practica2-TAIS/SplitString/SplitString.cpp

${OBJECTDIR}/_ext/1954233655/main.o: ../../Practica2-TAIS/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1954233655
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1954233655/main.o ../../Practica2-TAIS/main.cpp
